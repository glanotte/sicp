...
(define (make-instruction-sequence needs modifies statments)
  ...
  (let ((proc-code (compile (operator exp) 'proc 'next))
    ...
    (preserving '(env continue)
                ...
                (preserving '(proc continue)
                            ...
                            (compiled-procedure-call target linkage)))))
...
(define (compiled-procedure-call target linkage)
...
(define (append-instruction-sequences . seqs)
  (define (append-2-sequences seq 1 seq2)
    (make-instruction-sequence
      (list-union
